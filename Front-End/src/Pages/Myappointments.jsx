...
if (token) {
  ...
  return (
    <div>
      <p className='pt-3 mt-12 font-medium text-zinc-700 border-b'>My Appointment</p>
      <div>
         {appointments.map((item,index)=> (
          <div className='grid grid-cols-[1fr_2fr] gap-4 sm:flex sm:gap-6 py-2 borber-b' key={index}>
             <div>
